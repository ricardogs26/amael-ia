"""
OpenTelemetry tracing setup for k8s-agent.
Mirrors the pattern from backend-ia/agents/tracing.py.
Exports spans to the OTel Collector in the observability namespace.
"""
import os
import logging
...
SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "amael-k8s-agent")
...
try:
    ...
    # Auto-instrument outbound requests (kubernetes SDK uses requests library)

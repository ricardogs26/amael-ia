...
4. WEB_SEARCH: Úsala cuando el usuario pregunta sobre eventos actuales, noticias, precios, información reciente, o cualquier dato que requiera búsqueda en internet.
   REGLA DE ORO: Genera consultas de búsqueda TÉCNICAS y ESPECÍFICAS. Evita consultas genéricas como "cómo buscar en google" o "search help".
...
["K8S_TOOL: Buscar Ingress o Services relacionados con Claude Code", "REASONING: Explicar cómo conectar la herramienta basándose en la infraestructura encontrada"]
